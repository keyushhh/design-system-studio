 ...
 *   dss-projects-index-v1  → { activeId, projects: ProjectMeta[] }
 *   dss-project-<id>       → StoredSession   (one per deck)
 */

const INDEX_KEY = 'dss-projects-index-v1';
const SESSION_PREFIX = 'dss-project-';
/** Legacy single-session key, migrated into a project on first load. */
const LEGACY_KEY = 'dss-master-template-session-v1';
