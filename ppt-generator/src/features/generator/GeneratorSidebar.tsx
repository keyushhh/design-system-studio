  ...
  return (
    <aside className="sidenav">
      ...
      <div className="sidenav-brand flex flex-col gap-4 px-[20px] pt-6 pb-4 border-b border-neutral-150">
        <a href="/" title="Back to Design System Studio" className="flex flex-col select-none px-[8px] hover:opacity-80 transition-opacity cursor-pointer group no-underline text-current">
          <span className="flex items-center gap-1.5 font-display text-base font-bold tracking-[-0.02em] leading-[1.1] text-neutral-900 group-hover:text-emerald-600 transition-colors">
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-60 group-hover:opacity-100 group-hover:-translate-x-0.5 transition-all"><line x1="19" y1="12" x2="5" y2="12" /><polyline points="12 19 5 12 12 5" /></svg>
            Design System Studio
          </span>
          <span className="font-mono text-[9px] font-semibold tracking-[0.18em] uppercase text-neutral-400 mt-[2px] ml-[21px]">
            Token Engine
          </span>
        </a>
        <DeckSwitcher
            ...
            <button
              ...
              className={`flex items-center justify-center gap-1.5 py-1.5 px-1 rounded-none transition-all cursor-pointer font-sans text-[12px] font-normal tracking-normal shadow-none ${
                (deck.themeMode ?? 'hybrid') === 'hybrid'
                  ? 'bg-neutral-900 text-[var(--pure-white)]'
      ...
      <div className="sidenav-tools flex flex-col gap-3 p-4 border-t border-neutral-150 bg-neutral-50/50">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 h-[44px] px-4 rounded-[var(--radius-sharp)] font-sans font-bold text-[14px] bg-neutral-900 hover:bg-neutral-800 active:bg-neutral-950 text-[var(--pure-white)] transition-colors cursor-pointer"
        >
          <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>
          Source Material
          {hasPresentation && (
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="var(--emerald-500)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg>
          )}
        </button>
          ...
          className={`w-full flex items-center justify-center gap-2 h-[44px] px-4 rounded-[var(--radius-sharp)] font-sans font-bold text-[14px] transition-colors ${
            !hasPresentation
              ...
              : deckGenerated
                ...
                : 'border-none bg-neutral-900 hover:bg-neutral-800 active:bg-neutral-950 text-[var(--pure-white)] cursor-pointer'
          }`}
        >
          {deckGenerated && (
