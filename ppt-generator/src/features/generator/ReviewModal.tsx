...
export function ReviewModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-neutral-900/60 backdrop-blur-sm p-3 sm:p-6 overflow-y-auto" onClick={() => !busy && onClose()}>
      <div ref={panelRef} className="flex flex-col w-full max-w-6xl max-h-[92vh] sm:max-h-[90vh] bg-[var(--pure-white)] rounded-[var(--radius-sharp)] shadow-2xl overflow-hidden my-auto" onClick={(e) => e.stopPropagation()}>
        {/* Header */}
        <div className="flex items-start justify-between gap-4 px-5 py-4 sm:px-6 sm:py-5 border-b border-neutral-150 shrink-0">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="h-[34px] px-3.5 flex items-center gap-1.5 text-[12.5px] font-bold text-[var(--pure-white)] bg-neutral-900 hover:bg-neutral-800 rounded-[var(--radius-sharp)] transition-colors cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
            >
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 w-[25px] h-[25px] flex items-center justify-center rounded-full border-2 shadow-sm ${
                            isSelected
                              ...
                              : 'bg-[var(--pure-white)] border-neutral-300 text-neutral-300'
                          }`}
                        >
                        ...
                        <button
                          ...
                          className="absolute top-2 right-2 z-10 w-7 h-7 flex items-center justify-center rounded-[var(--radius-sharp)] shadow-sm transition-colors cursor-pointer bg-neutral-900/85 text-[var(--pure-white)] hover:bg-red-600"
                        >
                          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /></svg>
                        </button>
                        {!isSelected && (
                          <span className="absolute bottom-2 left-2 z-10 font-mono text-[9px] font-bold tracking-[0.1em] bg-neutral-900/80 text-[var(--pure-white)] px-1.5 py-0.5 rounded-[var(--radius-sharp)]">EXCLUDED</span>
                        )}
                      </div>
        ...
        {/* Footer actions */}
        <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-3.5 sm:px-6 sm:py-4 border-t border-neutral-150 shrink-0 bg-[var(--pure-white)]">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
            <button onClick={onPresent} disabled={!!busy || visible.length === 0} aria-label="Start presenting" className={`${btnBase} text-neutral-700 bg-[var(--pure-white)] hover:bg-neutral-50 border border-neutral-200`}>
            ...
            <button onClick={copyLink} disabled={!!busy} className={`${btnBase} text-neutral-700 bg-[var(--pure-white)] hover:bg-neutral-50 border border-neutral-200`}>
            ...
            <div className="relative" ref={exportMenuRef}>
              <button
                ...
                className={`${btnBase} text-[var(--pure-white)] bg-neutral-900 hover:bg-neutral-800`}
              >
              ...
              {exportMenuOpen && (
                <div className="absolute bottom-full right-0 mb-2 w-44 py-1.5 bg-[var(--pure-white)] border border-neutral-200 rounded-[var(--radius-sharp)] shadow-lg z-10">
